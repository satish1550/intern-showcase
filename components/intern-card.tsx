...
import { Linkedin, FileText, ChevronLeft, User, ArrowUpRight, Mail } from "lucide-react"
...
export function InternCard({ intern }: InternCardProps) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Front of card */}
        <div className={cn("card-content-front card-shadow flex flex-col items-center justify-center text-center", isHovered && !isFlipped ? "card-shadow-hover" : "")}>
          ...
          <div className="flex flex-col items-center justify-center w-full mb-4">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mb-1">{intern.name}</h2>
          ...
          <div className="flex flex-wrap justify-center gap-2 mt-auto">
            {intern.skills.slice(0, 5).map((skill, index) => (
        ...
        <div className="card-content-back card-shadow flex flex-col h-full">
          ...
          <div className="flex-1 min-h-0 overflow-y-auto pr-1">
            ...
            <p className="text-gray-700 mb-4 text-sm leading-relaxed">{intern.blurb}</p>
